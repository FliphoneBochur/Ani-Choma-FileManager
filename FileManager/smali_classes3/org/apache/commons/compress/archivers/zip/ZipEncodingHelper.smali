...
.method static constructor <clinit>()V
    ...
    .line 74
    .local v0, "se":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Lorg/apache/commons/compress/archivers/zip/ZipEncodingHelper$SimpleEncodingHolder;>;"
    const/16 v1, 0x80
    ...
    .line 100
    .local v3, "cp437":Lorg/apache/commons/compress/archivers/zip/ZipEncodingHelper$SimpleEncodingHolder;
    ...
    .line 130
    .local v1, "cp850_high_chars":[C
    new-instance v4, Lorg/apache/commons/compress/archivers/zip/ZipEncodingHelper$SimpleEncodingHolder;

    invoke-direct {v4, v1}, Lorg/apache/commons/compress/archivers/zip/ZipEncodingHelper$SimpleEncodingHolder;-><init>([C)V

    .line 132
    .local v4, "cp850":Lorg/apache/commons/compress/archivers/zip/ZipEncodingHelper$SimpleEncodingHolder;
    ...
    .line 168
    .end local v0    # "se":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Lorg/apache/commons/compress/archivers/zip/ZipEncodingHelper$SimpleEncodingHolder;>;"
    .end local v1    # "cp850_high_chars":[C
    .end local v2    # "cp437_high_chars":[C
    .end local v3    # "cp437":Lorg/apache/commons/compress/archivers/zip/ZipEncodingHelper$SimpleEncodingHolder;
    .end local v4    # "cp850":Lorg/apache/commons/compress/archivers/zip/ZipEncodingHelper$SimpleEncodingHolder;
    const/16 v0, 0x10
...
.method public static getZipEncoding(Ljava/lang/String;)Lorg/apache/commons/compress/archivers/zip/ZipEncoding;
    ...
    invoke-direct {v0}, Lorg/apache/commons/compress/archivers/zip/FallbackZipEncoding;-><init>()V
    ...
    .line 223
    .local v0, "h":Lorg/apache/commons/compress/archivers/zip/ZipEncodingHelper$SimpleEncodingHolder;
    if-eqz v0, :cond_2
    ...
    invoke-direct {v2, v1}, Lorg/apache/commons/compress/archivers/zip/NioZipEncoding;-><init>(Ljava/nio/charset/Charset;)V
    :try_end_0
    ...
    new-instance v2, Lorg/apache/commons/compress/archivers/zip/FallbackZipEncoding;

    invoke-direct {v2, p0}, Lorg/apache/commons/compress/archivers/zip/FallbackZipEncoding;-><init>(Ljava/lang/String;)V
